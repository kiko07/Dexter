...
class Step2ColumnSelector extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Column(
      ...
      children: [
        Text(
          AppLocalizations.of(context)!.selectColumns,
        ...
        Container(
          ...
          child: SwitchListTile(
            title: Text(
              AppLocalizations.of(context)!.importAllFieldsAuto,
        ...
        const SizedBox(height: 16),
        Text(
          AppLocalizations.of(context)!.chooseColumns,
          style: const TextStyle(fontWeight: FontWeight.bold),
        ),
        ...
        Container(
          ...
          child: DropdownButtonHideUnderline(
            child: DropdownButton<String>(
              ...
              items: state.selectedColumns.values.toSet().map((header) {
        ...
        Expanded(
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              final displayLetter = ExcelService.columnLetter(index + 1);
              ...
              return Container(
                ...
                child: CheckboxListTile(
                  ...
                  onChanged: state.importAllFields
                      ? null
                      : (val) {
